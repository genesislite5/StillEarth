...
class NPC2:
    def __init__(self, x, y, game):
        ...
        self.idle_sprites = self.load_spritesheet("NPC2/idle/pixil-frame-0-68.png", 12, 18, 6, self.target_width, self.target_height)
        self.run_sprites = self.load_spritesheet("NPC2/run/pixil-frame-0-71.png", 12, 18, 4, self.target_width, self.target_height)
