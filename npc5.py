...
from config import GEMINI_API_KEY_2
import os
...
class NPC5:
    def __init__(self, x, y, game):
        ...
        self.idle_sprites = self.load_spritesheet("NPC5/idle/pixil-frame-0-99.png", 12, 18, 6, self.target_width, self.target_height)
        self.run_sprites = self.load_spritesheet("NPC5/run/pixil-frame-0-97.png", 12, 18, 4, self.target_width, self.target_height)
