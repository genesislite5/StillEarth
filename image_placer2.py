...
class ImagePlacer:
    ...
    def save_position(self):
        if self.overlay_pos:
            with open('overlay_position2.json', 'w') as f:
                json.dump(list(self.overlay_pos), f)
            print("Overlay position saved.")

    def delete_position(self):
        self.overlay_pos = None
        if os.path.exists('overlay_position2.json'):
            os.remove('overlay_position2.json')
...
def main():
    ...
    image_placer = ImagePlacer('/Users/toneanmorgan/Downloads/pixil-frame-0-56.png', background_paths)
